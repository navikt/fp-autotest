...
echo FPINFO_IMAGE="docker.pkg.github.com/navikt/fpinfo/fpinfo:1.0-2021.03.02.113345-910d326" >> .env
...
echo FPTILBAKE_IMAGE="docker.pkg.github.com/navikt/fptilbake/fptilbake:1.0-2021.03.02.092044-46116f6" >> .env
