...
echo FPDOKGEN_NY_IMAGE="europe-north1-docker.pkg.dev/nais-management-233d/teamforeldrepenger/navikt/fp-dokgen:2026.03.02.095851-2812794" >> .env # Denne er ny versjon av fp-dokgen, og er ikke publisert til latest enda. Må oppdateres manuelt til den versjonen som er publisert
...
echo FPGRUNNDATA_IMAGE="$(imageVersion "europe-north1-docker.pkg.dev/nais-management-233d/teamforeldrepenger/navikt/fp-grunndata")" >> .env
