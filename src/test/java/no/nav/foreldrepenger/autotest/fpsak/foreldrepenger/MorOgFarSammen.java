...
import no.nav.foreldrepenger.vtp.kontrakter.person.arbeidsforhold.Permisjon;
                ...
                .forelder(mor().inntektytelse(
                        InntektYtelseGenerator.ny()
                                .arbeidsforhold(TestOrganisasjoner.NAV, "ARB001-001", null, fødselsdato.minusYears(5), null, årslønn,
                                        List.of(new Permisjon( fødselsdato.minusWeeks(3), morPermisjonTom, 100,
                                                Permisjon.Permisjonstype.PERMISJON_MED_FORELDREPENGER)),
