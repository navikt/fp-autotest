...
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.STØNADSKONTOTYPE_FELLESPERIODE;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.STØNADSKONTOTYPE_FORELDREPENGER_FØR_FØDSEL;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.STØNADSKONTOTYPE_MØDREKVOTE;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.UTSETTELSETYPE_ARBEID;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.UTSETTELSETYPE_INNLAGTBARN;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.UTSETTELSETYPE_INNLAGTSØKER;
import static no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.FordelingErketyper.UTSETTELSETYPE_SYKDOMSKADE;
...
import no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.OpptjeningErketyper;
import no.nav.foreldrepenger.autotest.dokumentgenerator.foreldrepengesoknad.erketyper.RettigheterErketyper;
...
public class Fodsel extends ForeldrepengerTestBase {
    ...
    public void morSøkerFødselSomSelvstendingNæringsdrivende_AvvikIBeregning() throws Exception {
        ...
        VurderVarigEndringEllerNyoppstartetSNBekreftelse vurderVarigEndringEllerNyoppstartetSNBekreftelse1 = saksbehandler.hentAksjonspunktbekreftelse(VurderVarigEndringEllerNyoppstartetSNBekreftelse.class);
        ...
        FastsettBruttoBeregningsgrunnlagSNBekreftelse fastsettBruttoBeregningsgrunnlagSNBekreftelse = saksbehandler.hentAksjonspunktbekreftelse(FastsettBruttoBeregningsgrunnlagSNBekreftelse.class);
        fastsettBruttoBeregningsgrunnlagSNBekreftelse.setBruttoBeregningsgrunnlag(1_000_000)
        ...
        FatterVedtakBekreftelse bekreftelse = beslutter.hentAksjonspunktbekreftelse(FatterVedtakBekreftelse.class);
        bekreftelse.godkjennAksjonspunkter(Arrays.asList(ap1, ap2));
        beslutter.fattVedtakOgVentTilAvsluttetBehandling(bekreftelse);
    ...
    public void morSøkerFødselMedToArbeidsforhold_AvvikIBeregning() throws Exception {
        ...
        fordel.erLoggetInnMedRolle(Aktoer.Rolle.SAKSBEHANDLER);
        long saksnummer = fordel.sendInnSøknad(søknad.build(), testscenario, DokumenttypeId.FOEDSELSSOKNAD_FORELDREPENGER);
        InntektsmeldingBuilder inntektsmeldingBuilder_1 = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr_1)
                .medRefusjonsBelopPerMnd(refusjon)
                .medArbeidsforholdId(arbeidsforholdId_1);
        InntektsmeldingBuilder inntektsmeldingBuilder_2 = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr_2)
                .medRefusjonsBelopPerMnd(refusjon)
    ...
    public void morSøkerFødselMedEttArbeidsforhold_AvvikIBeregning() throws Exception {
        ...
        SøknadBuilder søknad = SøknadErketyper.foreldrepengesøknadFødselErketype(aktørID, SøkersRolle.MOR, 1, fødselsdato);
        fordel.erLoggetInnMedRolle(Rolle.SAKSBEHANDLER);
        long saksnummer = fordel.sendInnSøknad(søknad.build(), testscenario, DokumenttypeId.FOEDSELSSOKNAD_FORELDREPENGER);

        InntektsmeldingBuilder inntektsmeldingBuilder = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr)
                .medRefusjonsBelopPerMnd(refusjon);
        fordel.sendInnInntektsmelding(inntektsmeldingBuilder, testscenario, saksnummer);
    ...
    public void farSøkerFødselMedEttArbeidsforhold() throws Exception {
        ...
        SøknadBuilder søknad = SøknadErketyper.foreldrepengesøknadFødselErketype(søkerAktørIdent, SøkersRolle.FAR, 1, fødselsdato);
        fordel.erLoggetInnMedRolle(Rolle.SAKSBEHANDLER);
    ...
    public void morSøkerFødselMedPrivatpersonSomArbeidsgiver() throws Exception {
        ...
        TestscenarioDto arbeidsgiverScenario = opprettTestscenarioFraVTPTemplate("59");
        String arbeidsgiverFnr = arbeidsgiverScenario.getPersonopplysninger().getSøkerIdent();

        // Lag testscenario
        TestscenarioDto testscenario = opprettScenarioMedPrivatArbeidsgiverFraVTPTemplate("152", arbeidsgiverFnr);
    ...
    public void farSøkerFødselAleneomsorgMenErGiftOgBorMedAnnenpart() throws Exception {
        ...
        Foreldrepenger foreldrepenger = new ForeldrepengerYtelseBuilder(
                ...
                FordelingErketyper.fordelingFarAleneomsorg(fødselsdato))
                .medRettigheter(RettigheterErketyper.harAleneOmsorgOgEnerett())
                .build();
        SøknadBuilder søknad = new SøknadBuilder(foreldrepenger, søkerAktørIdent, SøkersRolle.FAR);
    ...
    public void morSøkerFødselAleneomsorgKunEnHarRett() throws Exception {
        ...
        Foreldrepenger foreldrepenger = new ForeldrepengerYtelseBuilder(
                SoekersRelasjonErketyper.fødsel(1, fødselsdato),
                FordelingErketyper.fordelingMorAleneomsorgHappyCase(fødselsdato))
                .medRettigheter(RettigheterErketyper.harAleneOmsorgOgEnerett())
                .build();
        SøknadBuilder søknad = new SøknadBuilder(foreldrepenger, søkerAktørIdent, SøkersRolle.MOR);
        fordel.erLoggetInnMedRolle(Aktoer.Rolle.SAKSBEHANDLER);
    ...
    public void morSøker2Barn1Registrert() throws Exception {
        ...
        SøknadBuilder søknad = SøknadErketyper.foreldrepengesøknadFødselErketype(søkerAktørIdent, SøkersRolle.MOR, 2, fødselsdato);
        fordel.erLoggetInnMedRolle(Rolle.SAKSBEHANDLER);
        long saksnummer = fordel.sendInnSøknad(søknad.build(), testscenario, DokumenttypeId.FOEDSELSSOKNAD_FORELDREPENGER);
        List<InntektsmeldingBuilder> inntektsmeldinger = makeInntektsmeldingFromTestscenario(testscenario, startDatoForeldrepenger);
        fordel.sendInnInntektsmeldinger(inntektsmeldinger, testscenario, saksnummer);
        ...
        VurderManglendeFodselBekreftelse fodselBekreftelse = saksbehandler.hentAksjonspunktbekreftelse(VurderManglendeFodselBekreftelse.class)
    ...
    public void utsettelse_med_avvik() throws Exception {
        ...
        fordel.erLoggetInnMedRolle(Rolle.SAKSBEHANDLER);
        Foreldrepenger foreldrepenger = new ForeldrepengerYtelseBuilder(
                SoekersRelasjonErketyper.fødsel(1, fødsel), fordeling)
                .build();
        SøknadBuilder søknad = new SøknadBuilder(foreldrepenger, søkerAktørId, SøkersRolle.MOR);
        long saksnummer = fordel.sendInnSøknad(søknad.build(), testscenario, DokumenttypeId.FOEDSELSSOKNAD_FORELDREPENGER);
        List<InntektsmeldingBuilder> inntektsmeldinger = makeInntektsmeldingFromTestscenario(testscenario, fpStartdato);
        inntektsmeldinger.get(0).medUtsettelse(UTSETTELSETYPE_ARBEID, fødsel.plusWeeks(15), fødsel.plusWeeks(18).minusDays(1));
        fordel.sendInnInntektsmeldinger(inntektsmeldinger, testscenario, saksnummer);
