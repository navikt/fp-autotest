...
public class Fodsel extends ForeldrepengerTestBase {
    ...
    public void morSøkerFødselMedEttArbeidsforholdOgFrilans_VurderOpptjening_VurderFaktaOmBeregning_AvvikIBeregning() throws Exception {
        ...
        InntektsmeldingBuilder inntektsmeldingBuilder = lagInntektsmeldingBuilder(inntektPerMåned, fnr, fpStartdato,
                orgNr);
        inntektsmeldingBuilder.medRefusjon(refusjon);
    ...
    public void morSøkerFødselMedToArbeidsforhold_AvvikIBeregning() throws Exception {
        ...
        fordel.erLoggetInnMedRolle(Aktoer.Rolle.SAKSBEHANDLER);
        long saksnummer = fordel.sendInnSøknad(søknad.build(), testscenario, DokumenttypeId.FOEDSELSSOKNAD_FORELDREPENGER);
        InntektsmeldingBuilder inntektsmeldingBuilder_1 = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr_1).medRefusjon(refusjon)
                .medArbeidsforholdId(arbeidsforholdId_1);
        InntektsmeldingBuilder inntektsmeldingBuilder_2 = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr_2).medRefusjon(refusjon)
    ...
    public void morSøkerFødselMedEttArbeidsforhold_AvvikIBeregning() throws Exception {
        ...
        InntektsmeldingBuilder inntektsmeldingBuilder = lagInntektsmeldingBuilder(inntektPrMåned, fnr, fpStartdato, orgNr).medRefusjon(refusjon);
        fordel.sendInnInntektsmelding(inntektsmeldingBuilder, testscenario, saksnummer);
    ...
    public void morSøkerFødselMedEttArbeidsforhold_papirsøknad() throws Exception {
        ...
        saksbehandler.bekreftAksjonspunktBekreftelse(aksjonspunktBekreftelseEndringssøknad);
        saksbehandler.ventTilAvsluttetBehandling();
    ...
    public void utsettelse_med_avvik() throws Exception {
        ...
        saksbehandler.hentAksjonspunktbekreftelse(AvklarFaktaUttakBekreftelse.AvklarFaktaUttakPerioder.class)
                .godkjennPeriode(fødsel.plusWeeks(6), fødsel.plusWeeks(9).minusDays(1), godkjenningskode, DokumentasjonType.INNLAGT_BARN)
                .godkjennPeriode(fødsel.plusWeeks(9), fødsel.plusWeeks(12).minusDays(1), godkjenningskode, DokumentasjonType.INNLAGT_SØKER)
                .godkjennPeriode(fødsel.plusWeeks(12), fødsel.plusWeeks(15).minusDays(1), godkjenningskode, DokumentasjonType.SYK_SØKER);
        saksbehandler.bekreftAksjonspunktBekreftelse(AvklarFaktaUttakBekreftelse.AvklarFaktaUttakPerioder.class);
        saksbehandler.bekreftAksjonspunktBekreftelse(ForesloVedtakBekreftelse.class);
