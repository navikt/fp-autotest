...
public class TestOrganisasjoner {
    ...
    public static final OrganisasjonDto NAV = new OrganisasjonDto(
            ...
            new OrganisasjonDto.Detaljer("ARBEIDS- OG VELFERDSETATEN", LocalDate.of(2003, Month.JANUARY, 1)));

    public static final OrganisasjonDto NAV_OSLO = new OrganisasjonDto(
            new OrganisasjonDto.Orgnummer("992257822"),
            new OrganisasjonDto.Detaljer("NAV FAMILIE- OG PENSJONSYTELSER OSLO", LocalDate.of(2003, Month.JANUARY, 1)));

    public static final OrganisasjonDto NAV_BERGEN = new OrganisasjonDto(
            new OrganisasjonDto.Orgnummer("992260432"),
            new OrganisasjonDto.Detaljer("NAV FAMILIE- OG PENSJONSYTELSER BERGEN", LocalDate.of(2003, Month.JANUARY, 1)));

    public static final OrganisasjonDto NAV_STORD = new OrganisasjonDto(
            new OrganisasjonDto.Orgnummer("992260475"),
            new OrganisasjonDto.Detaljer("NAV FAMILIE- OG PENSJONSYTELSER STORD", LocalDate.of(2003, Month.JANUARY, 1)));

    public static final OrganisasjonDto NAV_KLAGE_MIDT = new OrganisasjonDto(
            new OrganisasjonDto.Orgnummer("991078045"),
            new OrganisasjonDto.Detaljer("NAV KLAGEINSTANS MIDT-NORGE", LocalDate.of(2003, Month.JANUARY, 1)));
    ...
    private static final List<OrganisasjonDto> KJENTE_ORGANISASJONER = List.of(
            NAV, NAV_OSLO, NAV_BERGEN, NAV_STORD, NAV_KLAGE_MIDT, NYLIG_OPPSTATET);
