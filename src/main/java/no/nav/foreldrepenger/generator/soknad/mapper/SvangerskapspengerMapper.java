...
public final class SvangerskapspengerMapper {
    ...
    public static Søknad tilSvangerskapspengesøknad(SvangerskapspengesøknadDto s, List<VedleggDto> påkrevdeVedlegg, LocalDateTime mottattDato) {
        return new Søknad(mottattDato.toLocalDate(), tilSøker(s), tilYtelse(s, påkrevdeVedlegg), null, tilVedlegg(påkrevdeVedlegg));
    }
    ...
    public static Svangerskapspenger tilYtelse(SvangerskapspengesøknadDto s, List<VedleggDto> vedlegg) {
        return new Svangerskapspenger(s.barnSvp().termindato(),
            s.barnSvp().fødselsdato(),
