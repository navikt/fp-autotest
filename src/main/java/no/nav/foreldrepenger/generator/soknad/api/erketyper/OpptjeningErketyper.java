...
import no.nav.foreldrepenger.generator.soknad.api.dto.AnnenInntektDto;
import no.nav.foreldrepenger.generator.soknad.api.dto.FrilansInformasjonDto;
import no.nav.foreldrepenger.generator.soknad.api.dto.FrilansoppdragDto;
import no.nav.foreldrepenger.generator.soknad.api.dto.NæringDto;
import no.nav.foreldrepenger.generator.soknad.api.dto.NæringsinntektInformasjonDto;
import no.nav.foreldrepenger.generator.soknad.api.dto.TilknyttetPersonDto;
...
public final class OpptjeningErketyper {
    ...
    public static AnnenInntektDto utenlandskArbeidsforhold(CountryCode landKode) {
        return lagUtenlandskArbeidsforhold(landKode);
    }
    ...
    private static AnnenInntektDto lagUtenlandskArbeidsforhold(CountryCode landKode) {
