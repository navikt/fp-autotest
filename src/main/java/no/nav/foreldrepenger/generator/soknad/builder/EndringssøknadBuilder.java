...
public class EndringssøknadBuilder implements SøknadBuilder<EndringssøknadBuilder> {
    ...
    public EndringssøknadForeldrepengerDto build() {
        ...
        return new EndringssøknadForeldrepengerDto(mottattdato, søkerinfo, rolle, språkkode, barn, annenForelder, uttaksplan, saksnummer, vedlegg);
    }
}
