...
import static no.nav.foreldrepenger.generator.soknad.mapper.CommonMapper.tilOpptjening;
...
import static no.nav.foreldrepenger.generator.soknad.mapper.CommonMapper.tilVedleggsreferanse;
...
import no.nav.foreldrepenger.autotest.klienter.fpsoknad.kontrakt.foreldrepenger.annenpart.NorskForelderDto;
import no.nav.foreldrepenger.autotest.klienter.fpsoknad.kontrakt.foreldrepenger.annenpart.UtenlandskForelderDto;
import no.nav.foreldrepenger.autotest.klienter.fpsoknad.kontrakt.foreldrepenger.uttaksplan.KontoType;
import no.nav.foreldrepenger.autotest.klienter.fpsoknad.kontrakt.foreldrepenger.uttaksplan.OppholdsPeriodeDto;
import no.nav.foreldrepenger.autotest.klienter.fpsoknad.kontrakt.foreldrepenger.uttaksplan.OverføringsPeriodeDto;
...
public final class ForeldrepengerMapper {
    ...
    public static Søknad tilForeldrepengesøknad(ForeldrepengesøknadDto foreldrepengesøknad, List<VedleggDto> påkrevdeVedlegg, LocalDateTime mottattDato) {
        return new Søknad(mottattDato.toLocalDate(),
