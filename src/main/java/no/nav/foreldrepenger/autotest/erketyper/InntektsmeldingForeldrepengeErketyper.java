...
public class InntektsmeldingForeldrepengeErketyper {
    ...
    public static List<InntektsmeldingBuilder> makeInntektsmeldingFromTestscenarioMedIdent(
        ...
        arbeidsforholdEtterStartdatoFP.stream()
                .filter(arbeidsforhold -> (arbeidsforhold.getAnsettelsesperiodeTom() == null) ||
    ...
    public static InntektsmeldingBuilder lagInntektsmelding(Integer beløp, String fnr, LocalDate fpStartdato,
            String orgNr) {
    ...
    @Deprecated
    public static InntektsmeldingBuilder lagInntektsmeldingBuilderMedGradering(Integer beløp, String fnr,
            LocalDate fpStartdato, String orgNr, Integer arbeidsprosent, LocalDate graderingFom,
    ...
    @Deprecated
    public static InntektsmeldingBuilder lagInntektsmeldingBuilderMedEndringIRefusjonPrivatArbeidsgiver(Integer beløp,
            String fnr, LocalDate fpStartdato, String fnrArbeidsgiver, BigDecimal refusjon,
            Map<LocalDate, BigDecimal> endringRefusjonMap) {
        InntektsmeldingBuilder inntektsmelding = lagInntektsmeldingBuilderPrivatArbeidsgiver(beløp, fnr, fpStartdato,
                fnrArbeidsgiver);
