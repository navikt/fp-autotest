...
public class SøknadSvangerskapspengerErketype {
    public static SvangerskapspengerBuilder lagSvangerskapspengerSøknad(String søkerAktørId, SøkersRolle søkersRolle, LocalDate termin, List<Tilrettelegging> tilretteleggingListe) {
