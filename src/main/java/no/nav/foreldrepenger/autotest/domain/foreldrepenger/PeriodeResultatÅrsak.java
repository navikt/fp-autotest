...
public enum PeriodeResultatÅrsak {
    ...
    UTSETTELSE_GYLDIG_PGA_FERIE("2010", "§14-11 første ledd bokstav a: Gyldig utsettelserList pga. ferie"),
    UTSETTELSE_GYLDIG_PGA_100_PROSENT_ARBEID("2011", "§14-11 første ledd bokstav b: Gyldig utsettelserList pga. 100% arbeid"),
    UTSETTELSE_GYLDIG_PGA_INNLEGGELSE("2012", "§14-11 første ledd bokstav c: Gyldig utsettelserList pga. innleggelse"),
    UTSETTELSE_GYLDIG_PGA_BARN_INNLAGT("2013", "§14-11 første ledd bokstav d: Gyldig utsettelserList pga. barn innlagt"),
    UTSETTELSE_GYLDIG_PGA_SYKDOM("2014", "§14-11 første ledd bokstav c: Gyldig utsettelserList pga. sykdom"),
    ...
    UTSETTELSE_GYLDIG("2024", "§14-11: Gyldig utsettelserList"),
    UTSETTELSE_GYLDIG_SEKS_UKER_INNLEGGELSE("2025", "§14-11: Gyldig utsettelserList første 6 uker pga. innleggelse"),
    UTSETTELSE_GYLDIG_SEKS_UKER_FRI_BARN_INNLAGT("2026", "§14-11: Gyldig utsettelserList første 6 uker pga. barn innlagt"),
    UTSETTELSE_GYLDIG_SEKS_UKER_FRI_SYKDOM("2027", "§14-11: Gyldig utsettelserList første 6 uker pga. sykdom"),
    ...
    UTSETTELSE_FØR_TERMIN_FØDSEL("4030", "§14-9: Avslag utsettelserList før termin/fødsel"),
    ...
    INGEN_STØNADSDAGER_IGJEN("4034", "§14-11, jf §14-9: Avslag utsettelserList - ingen stønadsdager igjen"),
    ...
    UTSETTELSE_FERIE_PÅ_BEVEGELIG_HELLIGDAG("4041", "§14-11 første ledd bokstav a: Avslag utsettelserList ferie på bevegelig helligdag"),
    ...
    AVSLAG_UTSETTELSE_PGA_FERIE_TILBAKE_I_TID("4081", "§14-11 første ledd bokstav a: Avslag utsettelserList pga ferie tilbake i tid"),
    AVSLAG_UTSETTELSE_PGA_ARBEID_TILBAKE_I_TID("4082", "§14-11 første ledd bokstav b: Avslag utsettelserList pga arbeid tilbake i tid"),
    ...
    DEN_ANDRE_PART_HAR_OVERLAPPENDE_UTTAKSPERIODER_SOM_ER_INNVILGET_UTSETTELSE("4086", "§14-10 sjette ledd og §14-11: Annen part har overlappende uttaksperioder som er innvilget utsettelserList"),
