...
import static no.nav.foreldrepenger.autotest.klienter.BaseUriProvider.FPSAK_FORVALTNING_BASE;
...
public class ProsesstaskFpsakKlient implements ProsessTaskKlient {
    ...
    public ProsesstaskFpsakKlient() {
        prosesstaskKlient = new ProsesstaskKlientFelles(FPSAK_FORVALTNING_BASE, SaksbehandlerRolle.DRIFTER, "fpsak");
    }
