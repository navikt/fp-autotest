...
public class AksjonspunktKoder {
    ...
    public static final String OVERSTYRING_AV_SØKNADSFRISTVILKÅRET = "6006";
    public static final String OVERSTYRING_AV_OPPTJENINGSVILKÅRET = "6011";
    ...
    public static final String VURDER_INNSYN = "5037";
    public static final String FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS = "5038";
    public static final String FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD = "5047";
    public static final String FASTSETT_BEREGNINGSGRUNNLAG_FOR_SN_NY_I_ARBEIDSLIVET = "5049";
    public static final String AVKLAR_BEREGNINGSGRUNNLAG_OG_INNTEKTSKATEGORI_FOR_BRUKER_MED_TILSTØTENDE_YTELSE = "5050";
    public static final String AVKLAR_AKTIVITETER = "5052";

    public static final String MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG = "5060";
    public static final String VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NÆRING_SELVSTENDIG_NÆRINGSDRIVENDE = "5039";
    public static final String REGISTRER_PAPIRSØKNAD_FORELDREPENGER = "5040";
    public static final String REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER = "5057";
    public static final String VURDER_FAKTA_FOR_ATFL_SN = "5058";
    public static final String VURDER_REFUSJON_BERGRUNN = "5059";
    public static final String FORDEL_BEREGNINGSGRUNNLAG = "5046";
    ...
    public static final String AVKLAR_STARTDATO_FOR_FORELDREPENGEPERIODEN = "5045";
