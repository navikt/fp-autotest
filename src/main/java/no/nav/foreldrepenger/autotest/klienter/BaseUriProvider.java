...
public class BaseUriProvider {
    public static final URI AZURE_ROOT = URI.create("http://127.0.0.1:8085");
    public static final URI VTP_ROOT = URI.create("http://127.0.0.1:8060");
    ...
    public static final URI FPTILBAKE_BASE = URI.create("http://127.0.0.1:8031/fptilbake/api");
