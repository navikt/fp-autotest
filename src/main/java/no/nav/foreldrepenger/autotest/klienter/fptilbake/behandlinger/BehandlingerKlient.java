...
public class BehandlingerKlient extends FptilbakeKlient {
    ...
    public FeilutbetalingDto hentFeilutbetalingFakta(int behandlingId) throws IOException {
    ...
    public void postAksjonspunkt(BehandledeAksjonspunkter aksjonspunkter) throws IOException {
