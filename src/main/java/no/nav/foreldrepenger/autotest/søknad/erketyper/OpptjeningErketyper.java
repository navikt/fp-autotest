...
import no.nav.foreldrepenger.autotest.søknad.modell.felles.opptjening.Frilans;
import no.nav.foreldrepenger.autotest.søknad.modell.felles.opptjening.FrilansOppdrag;
import no.nav.foreldrepenger.autotest.søknad.modell.felles.opptjening.NorskOrganisasjon;
import no.nav.foreldrepenger.autotest.søknad.modell.felles.opptjening.Opptjening;
import no.nav.foreldrepenger.autotest.søknad.modell.felles.opptjening.Regnskapsfører;
...
public final class OpptjeningErketyper {
    ...
    public static Opptjening medUtenlandskArbeidsforhold(String landKode) {
        UtenlandskArbeidsforhold utenlandskArbeidsforhold = lagUtenlandskArbeidsforhold(landKode);
        return Opptjening.builder()
