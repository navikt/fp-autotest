...
5. Velg nøkkeltype "Signing"
6. Kopier innholdet av filen "~/.ssh/id_rsa.pub" og lim inn i "Key".
7. Velg "Add SSH key".
8. Trykk på "Enable SSO", "Authorize" (NAV) og følg anvisningene videre for å godkjenne token gjennom SSO.
9. Configurer git til å bruke nøkkelen din.
   ```bash
